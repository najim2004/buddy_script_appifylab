      ...
      <div className="flex items-start px-6">
        ...
        <div className="relative flex-1">
          <Textarea
            ...
            className="text-content placeholder:text-muted-foreground min-h-[88px] resize-none rounded-md border-0 bg-transparent px-2 py-2 text-base shadow-none focus-visible:ring-0"
          />
        </div>
      </div>

      <div className="p-6">
        <div className="bg-brand-tint mt-2.5 flex h-16 items-center justify-between rounded-md rounded-b-md px-4">

    ...
    <div className="space-y-6 lg:sticky lg:top-[90px]">
      ...
      <div className="rounded-[6px] bg-bs-bg2 p-6 pb-[6px]">
        ...
        <ul className="m-0 p-0 list-none">
          ...
          <li className="mb-[15px]">
            <Link href="#" className="flex items-center text-[15px] font-medium text-bs-color6 transition-colors hover:text-primary group">
              <svg className="mr-3" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path className="transition-colors group-hover:stroke-primary" d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                <circle className="transition-colors group-hover:stroke-primary" cx="9" cy="7" r="4"></circle>
                <path className="transition-colors group-hover:stroke-primary" d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
                <path className="transition-colors group-hover:stroke-primary" d="M16 3.13a4 4 0 0 1 0 7.75"></path>
              </svg>
              Group
            </Link>
          </li>
          ...
          <li className="mb-[15px]">
            <Link href="#" className="flex items-center text-[15px] font-medium text-bs-color6 transition-colors hover:text-primary group">
              <svg className="mr-3" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path className="transition-colors group-hover:stroke-primary" d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"></path>
                <polyline className="transition-colors group-hover:stroke-primary" points="17 21 17 13 7 13 7 21"></polyline>
                <polyline className="transition-colors group-hover:stroke-primary" points="7 3 7 8 15 8"></polyline>
              </svg>
              Save post
            </Link>
          </li>
      ...
      <div className="rounded-[6px] bg-bs-bg2 p-6 pb-[6px]">
        <div className="mb-6 flex items-center justify-between">
          <h4 className="text-[18px] font-semibold text-bs-color">Suggested People</h4>
          <Link href="#" className="text-sm font-medium text-bs-color7 transition-colors hover:text-primary">See All</Link>
        </div>
        ...
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center">
            <Link href="#" className="mr-3 block h-[46px] w-[46px] shrink-0 overflow-hidden rounded-full">
              <Image src="/assets/images/people1.png" alt="Steve Jobs" width={46} height={46} className="h-full w-full object-cover" />
            </Link>
            <div>
              <Link href="#" className="text-[15px] font-semibold text-bs-color transition-colors hover:text-primary">Steve Jobs</Link>
              <p className="text-sm font-normal text-bs-color7">CEO of Apple</p>
            </div>
          </div>
          <Link href="#" className="text-sm font-semibold text-primary">Connect</Link>
        </div>
        ...
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center">
            <Link href="#" className="mr-3 block h-[46px] w-[46px] shrink-0 overflow-hidden rounded-full">
              <Image src="/assets/images/people2.png" alt="Ryan Roslansky" width={46} height={46} className="h-full w-full object-cover" />
            </Link>
            <div>
              <Link href="#" className="text-[15px] font-semibold text-bs-color transition-colors hover:text-primary">Ryan Roslansky</Link>
              <p className="text-sm font-normal text-bs-color7">CEO of Linkedin</p>
            </div>
          </div>
          <Link href="#" className="text-sm font-semibold text-primary">Connect</Link>
        </div>
        ...
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center">
            <Link href="#" className="mr-3 block h-[46px] w-[46px] shrink-0 overflow-hidden rounded-full">
              <Image src="/assets/images/people3.png" alt="Dylan Field" width={46} height={46} className="h-full w-full object-cover" />
            </Link>
            <div>
              <Link href="#" className="text-[15px] font-semibold text-bs-color transition-colors hover:text-primary">Dylan Field</Link>
              <p className="text-sm font-normal text-bs-color7">CEO of Figma</p>
            </div>
          </div>
          <Link href="#" className="text-sm font-semibold text-primary">Connect</Link>
        </div>
      ...
      <div className="rounded-[6px] bg-bs-bg2 p-6 pb-[6px]">
        <div className="mb-6 flex items-center justify-between">
          <h4 className="text-[18px] font-semibold text-bs-color">Events</h4>
          <Link href="#" className="text-sm font-medium text-bs-color7 transition-colors hover:text-primary">See all</Link>
        </div>

        {/* Event 1 */}
        <Link href="#" className="mb-4 block transition-colors group">
          <div className="overflow-hidden rounded-[6px] border border-transparent group-hover:border-primary">
            <div className="h-[120px] w-full bg-gray-200 relative">
              <Image src="/assets/images/feed_event1.png" alt="Event" fill className="object-cover" />
            </div>
            <div className="flex bg-bs-bg2 p-3 pb-0">
              <div className="mr-3 flex shrink-0 flex-col items-center justify-center rounded-[6px] bg-[#1890ff1a] px-[10px] py-[6px]">
                <span className="text-[18px] font-semibold leading-tight text-primary">10</span>
                <span className="text-[11px] font-medium leading-tight text-primary uppercase">Jul</span>
              </div>
              <div>
                <h4 className="text-[15px] font-semibold leading-tight text-bs-color group-hover:text-primary transition-colors line-clamp-2">No more terrorism no more cry</h4>
              </div>
            </div>
            <div className="mx-3 mt-3 border-t border-bs-bcolor1 pt-3 pb-3 flex items-center justify-between">
              <span className="text-[13px] font-normal text-bs-color7">17 People Going</span>
              <span className="text-[13px] font-semibold text-primary">Going</span>
            </div>
          </div>
        </Link>
      </div>

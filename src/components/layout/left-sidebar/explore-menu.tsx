  ...
  },
  {
    ...
    icon: (
      <svg className="mr-3" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path className="group-hover:stroke-primary transition-colors" d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
        <circle className="group-hover:stroke-primary transition-colors" cx="9" cy="7" r="4"></circle>
        <path className="group-hover:stroke-primary transition-colors" d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
        <path className="group-hover:stroke-primary transition-colors" d="M16 3.13a4 4 0 0 1 0 7.75"></path>
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg className="mr-3" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path className="group-hover:stroke-primary transition-colors" d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"></path>
        <polyline className="group-hover:stroke-primary transition-colors" points="17 21 17 13 7 13 7 21"></polyline>
        <polyline className="group-hover:stroke-primary transition-colors" points="7 3 7 8 15 8"></polyline>
      </svg>
    ),
  },
];
    ...
    <div className="bg-card rounded-lg p-6 pb-1.5">
      ...
      <ul className="m-0 list-none space-y-6 p-0">
        {EXPLORE_ITEMS.map((item) => (
          <li key={item.name} className={item.name === "Settings" || item.name === "Save post" ? "mb-[15px]" : ""}>
            <Link
              href={item.href}
